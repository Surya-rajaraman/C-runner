...
var lifesGroup, life1, life2, life3, life4, life5, life6;
...
function preload(){
  ...
  life1 = loadImage("mask2.png");
  life2 = loadImage("sanitizer.png");
  life3 = loadImage("hand.png");
  life4 = loadImage("mask2.png");
  life5 = loadImage("mask2.png");
  life6 = loadImage("mask2.png");

  
  obstacle1 = loadImage("covid.png");
  obstacle2 = loadImage("covid3.png");
  obstacle3 = loadImage("covid.png");
  obstacle4 = loadImage("covid3.png");
  ...
  if (frameCount % 80 === 0) {
    ...
    switch(rand) {
      ...
      case 4: life.addImage(life4);
              break;
      case 5: life.addImage(life5);
              break;
      case 6: life.addImage(life6);
              break;
      default: break;
    }
    life.scale = 0.2;
